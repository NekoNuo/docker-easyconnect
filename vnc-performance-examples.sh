...
echo "  -e VNC_ENCODING=tight \\"
echo "  -e VNC_QUALITY=1 \\"
echo "  -e VNC_COMPRESS=9 \\"
echo "  -e VNC_FRAMERATE=8 \\"
echo "  -e VNC_DEPTH=8 \\"
echo "  -e VNC_SIZE=640x480 \\"
echo "  -p 127.0.0.1:5901:5901 \\"
echo "  -p 127.0.0.1:1080:1080 \\"
echo "  -p 127.0.0.1:8888:8888 \\"
echo "  hagb/docker-easyconnect:latest"
...
echo ""
echo "# 低资源优化检测"
echo "docker exec <container_name> vnc-lowres-optimizer.sh detect"
echo ""
echo "# 应用低资源配置"
echo "docker exec <container_name> vnc-lowres-optimizer.sh apply"
echo ""
echo "# 实时资源监控"
echo "docker exec <container_name> vnc-lowres-optimizer.sh monitor"
echo ""
echo "# 运行性能测试"
...
echo "VNC_AUTO_LOWRES:  启用低资源自动检测 (0/1)"
...
echo "  - 低帧率 (5-15fps)"
echo "  - 低色彩深度 (8-16bit)"
echo "  - 小分辨率 (640x480 或 800x600)"
echo "  - 启用资源限制: --memory=512m --cpus=1.0"
